...
function page() {
    ...
    function performOperation() {
        ...
        switch (option) {
            case "+":
                result.hours =
                    parseInt(inputs.hours, 10) + parseInt(input_2.hours, 10);
                result.minutes =
                    parseInt(inputs.minutes, 10) +
                    parseInt(input_2.minutes, 10);
                result.seconds =
                    parseInt(inputs.seconds, 10) +
                    parseInt(input_2.seconds, 10);
                result.milliseconds =
