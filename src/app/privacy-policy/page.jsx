function page() {
    return (
        <div className="p-8 w-[20rem] md:w-[40rem] md:text-xl mx-auto">
            <h1 className="font-bold text-center text-lg">
                Privacy Policy for DateTimeCalculators
            </h1>

            <div className="text-center space-y-3">
                <p>
                    At datetimecalculators.com, accessible from
                    https://datetimecalculators.com, one of our main priorities
                    is the privacy of our visitors. This Privacy Policy document
                    contains types of information that is collected and recorded
                    by datetimecalculators.com and how we use it.
                </p>
                ...
                <p>
                    ...
                    datetimecalculators.com. This policy is not applicable to
                    any information collected offline or via channels other than
                    this website.
                </p>

                <h2 className="font-semibold text-center">Consent</h2>
                ...
                <h2 className="font-semibold text-center">Log Files</h2>

                <p>
                    datetimecalculators.com follows a standard procedure of
                ...
                <p>
                    Like any other website, datetimecalculators.com uses
                ...
                <p>
                    ...
                    each of the advertising partners of datetimecalculators.com.
                </p>
                ...
                <p>
                    ...
                    datetimecalculators.com, which are sent directly to users'
                ...
                <p>
                    Note that datetimecalculators.com has no access to or
                ...
                <p>
                    datetimecalculators.com's Privacy Policy does not apply to
                ...
                <p>
                    datetimecalculators.com does not knowingly collect any
