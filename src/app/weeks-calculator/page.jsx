            ...
            <div className="mx-auto w-[20rem] md:w-[40rem] space-y-4 mb-8 p-2">
                ...
                <div className="space-y-2">
                    ...
                    <p>
                        ...
                        <Link href="/weeks-from-now-calculator">
                            weeks from now
                        </Link>{" "}
                        (➕ add weeks) and{" "}
                        <Link href="/weeks-ago-calculator">weeks ago</Link> (➖
                        subtract weeks) (interlink weeks ago calc), this Weeks
                        Calculator offers additional flexibility. It allows you
                        to select a custom starting date and combines this
                        feature with the ability to calculate the number of
