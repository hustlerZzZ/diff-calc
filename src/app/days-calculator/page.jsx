            ...
            <div className="mx-auto w-[20rem] md:w-[40rem] space-y-4 mb-8 p-2">
                ...
                <div className="space-y-2">
                    ...
                    <p>
                        ...
                        <Link
                            className="text-blue-400"
                            href="/days-ago-calculator"
                        >
                            days ago
                        </Link>{" "}
                        (➖) , this Days Calculator offers the flexibility to
                        change the starting date and includes the option to
                        calculate the days between two dates, making it a
                        versatile tool for your date calculation needs.
                    </p>
                </div>
            </div>
            <RelatedLink />
