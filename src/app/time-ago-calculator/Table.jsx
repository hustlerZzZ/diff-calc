    ...
    return (
        <div className="p-4">
            <table className="table-auto">
                <thead>
                    <tr>
                        <th className="px-4 py-2 bg-blue-500">Time Ago</th>
                    ...
                    {hours.map((hour, index) => (
                        <tr key={index}>
                            <td className="border px-4 py-2 bg-blue-300">
                                {index < 10 && startIndex > 26
                                    ? `0${index + startIndex}:00 ago`
                                    : `${index + startIndex}:00 ago`}
                            </td>
...
const App = () => {
    ...
    const next50Hours = Array.from({ length: 50 }, (_, index) => {
        ...
        hourDate.setHours(currentDate.getHours() - index);
        return hourDate;
    });
